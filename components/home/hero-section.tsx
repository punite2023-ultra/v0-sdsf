...
function StarCore() {
  return (
    <svg
      viewBox="0 0 512 512"
      className="h-[84px] w-[84px] fill-[#CCFF00]"
      aria-hidden="true"
    >
...
function RotatingBadge() {
  return (
    <div className="relative flex h-[170px] w-[170px] items-center justify-center">
      <div className="absolute inset-0 rounded-full border-[4px] border-[#CCFF00] hero-ring-spin" />
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1720px] flex-col justify-center px-5 py-8 md:px-8 xl:px-10">
        <div className="relative min-h-[860px] w-full">
          <div className="pointer-events-none absolute left-1/2 top-[7%] z-[8] w-full -translate-x-1/2 text-center">
            <div
              className={`${anton.className} hero-fill-text text-[#CCFF00]`}
              style={{
            ...
            <div
              className={`${anton.className} hero-fill-text -mt-[4.8vw] text-[#CCFF00]`}
              style={{
                transform: `translate(${mouse.x * 10}px, ${mouse.y * 5}px)`,
              }}
            >
          ...
          <div className="relative z-10 grid min-h-[860px] grid-cols-1 items-center gap-6 pt-24 xl:grid-cols-[20%_52%_20%] xl:justify-between xl:gap-0">
            ...
            >
              ...
              <div className="mb-5 h-[3px] w-[178px] bg-[#CCFF00]" />
              ...
              <div className="mt-24 space-y-10">
                <div>
                  ...
                  >
                    500<span className="text-[#CCFF00]">+</span>
                  </div>
                  <div
                  ...
                  <div className="mt-7 h-[3px] w-[178px] bg-[#CCFF00]" />
                </div>
                ...
                <div>
                  <div
                    className={`${anton.className} text-[88px] leading-none tracking-[-0.05em]`}
                  >
                    125<span className="text-[#CCFF00]">+</span>
                  </div>
                  <div
                    className={`${anton.className} mt-2 text-[24px] uppercase leading-none`}
                  >
            ...
            >
              ...
              <div className="mt-10 flex justify-end">
                <Link
                  href="/contact"
                  className={`${anton.className} hero-ripple group relative inline-flex items-center gap-4 overflow-hidden border-[3px] border-[#CCFF00] px-8 py-5 text-[18px] uppercase tracking-[0.08em] text-white transition duration-300 hover:bg-[#CCFF00] hover:text-black`}
                >
                  <span className="relative z-10">GET STARTED</span>
                  <span className="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white text-black transition duration-300 group-hover:bg-black group-hover:text-[#CCFF00]">
          ...
          <div className="mt-8 grid gap-6 xl:hidden">
            ...
            <div>
              <Link
                href="/contact"
                className={`${anton.className} hero-ripple group relative inline-flex items-center gap-4 overflow-hidden border-[3px] border-[#CCFF00] px-6 py-4 text-base uppercase tracking-[0.08em] text-white transition duration-300 hover:bg-[#CCFF00] hover:text-black`}
              >
                <span className="relative z-10">GET STARTED</span>
                <span className="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white text-black transition duration-300 group-hover:bg-black group-hover:text-[#CCFF00]">
                  <MoveRight className="h-5 w-5" />
      ...
      <style jsx>{`
        ...
        .hero-ripple::after {
          ...
          box-shadow: 0 0 30px rgba(204, 255, 0, 0.55);
